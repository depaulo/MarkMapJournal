...
const APP_VERSION = 'markmap-journal-pwa-v1';
...
const LOCAL_APP_SHELL = [
  ...
  './css/app.css',
  './js/main.js',
  './js/render/html-preview.js',
  './js/data/templates-data.js',
];
...
function isSafeToCacheResponse(response: Response) {
...
async function putInCache(cacheName: string, request: Request, response: Response) {
  try {
...
async function precacheOne(cache: Cache, url: string) {
  try {
