// Static template data extracted from main.js.
export const __TPL_ORG = [
    { id: 'meeting_notes', name: '🗓️ Meeting Notes', body: `# 🗓️ Meeting Notes
## 🎯 Purpose
- ⟨Why are we meeting?⟩
## 👥 Attendees
- ⟨Name⟩
...
- ⟨Out of scope topic⟩
` },
    { id: 'one_on_one', name: '🤝 1:1 Notes', body: `# 🤝 1:1 Notes
## 🧭 Context
...
- [ ] ⟨Action⟩ — ⟨Owner⟩ — ⟨Due date⟩
` },
    { id: 'project_plan', name: '🚀 Project Plan', body: `# 🚀 Project Plan
## 🎯 Goal
...
- [ ] ⟨Action⟩ — ⟨Owner⟩ — ⟨Due date⟩
` },
    { id: 'decision_record', name: '🧾 Decision Record', body: `# 🧾 Decision Record
## 🧠 Context
...
- [ ] ⟨Action⟩ — ⟨Owner⟩ — ⟨Due date⟩
` },
    { id: 'weekly_update', name: '📣 Weekly Update', body: `# 📣 Weekly Update
## 🧭 Summary
...
- ⟨Event / deadline⟩
` },
    { id: 'brainstorm', name: '💡 Brainstorm', body: `# 💡 Brainstorm
## 🧩 Problem Statement
...
- [ ] ⟨Action⟩ — ⟨Owner⟩ — ⟨Due date⟩
` },
    { id: 'sop_checklist', name: '📋 SOP / Checklist', body: `# 📋 SOP / Checklist
## 🎯 Purpose
...
` },
    { id: 'rfc_proposal', name: '🧠 RFC / Proposal', body: `# 🧠 RFC / Proposal
## 🧾 Summary
- ⟨One paragraph⟩
## 🎯 Problem
